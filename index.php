...
<body class="bg-light">
	<div class="text-center p-5">
		...
		<h1 class="mt-5">You can Download TikTok Videos easily!</h1>
		
	</div>
	<div class="text-center">
		Paste a video url below and press "Download". Now scroll down to "Download Watermark Free!" or "Download Video" button<br><br>
		<form method="POST" class="mt-2">
			<input type="text" placeholder="https://www.tiktok.com/@username/video/2468109937281" class="mb-3" name="tiktok-url"><br><br>
	...
	<div class="border m-3 mb-5" id="result">
		<div class="row m-0 p-2">
			...
			<div class="col-sm-6 col-md-6 col-lg-6 text-center mt-5"><ul style="list-style: none;padding: 0px">
				<li>Video Created by:  <b>@<?php echo $username; ?></b></li>
				<li>Uploaded: <b><?php echo $create_time; ?></b></li>
				...
				<li><div class="alert alert-primary mb-0 mt-3">If the video opens directly, try saving it by pressing CTRL+S.</div></li>
			</ul></div>
		</div>
	</div>
	<?php
			...
			else
			{
				...
				<div class="mx-5 px-5 my-3" id="result">
					<div class="alert alert-danger mb-0"><b>Please check your url and try again.</b></div>
				</div>
	...
	<div class="bg-dark text-white" style="position: fixed; bottom: 0;width: 100%;padding:15px"><a target="_blank" href="https://www.github.com/TufayelLUS"></a> <span >Copyright &copy; <?php echo date("Y"); ?></span></div>
    <script type="text/javascript">
